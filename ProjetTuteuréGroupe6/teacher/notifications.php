...
try {
    ...
    $_SESSION['error'] = "Erreur lors du chargement des notifications : " . $e->getMessage();
}
                ...
                <ul class="notifications-list">
                    <?php foreach ($notifications as $notification): ?>
                        <li class="notification-item">
                            ...
                            <small class="notification-date"><?php echo htmlspecialchars(date('d/m/Y H:i', strtotime($notification['created_at']))); ?></small>
                        </li>
                    <?php endforeach; ?>
                </ul>
            <?php else: ?>
